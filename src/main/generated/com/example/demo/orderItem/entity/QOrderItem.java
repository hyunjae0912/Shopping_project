...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    private static final long serialVersionUID = -102689571L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QOrderItem orderItem = new QOrderItem("orderItem");

    public final com.example.demo.order.entity.QOrder order;
    ...
    public QOrderItem(Class<? extends OrderItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new com.example.demo.order.entity.QOrder(forProperty("order"), inits.get("order")) : null;
